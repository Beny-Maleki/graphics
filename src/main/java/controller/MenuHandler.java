...
//    }
    ...
    public static void changeMenu(AddressFXML addressFXML) throws FileNotFoundException {
        try {
            Scene scene = SceneCreator.create(addressFXML);
